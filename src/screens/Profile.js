...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: theme.colors.primaryLight, alignItems: 'center', justifyContent: 'center', marginBottom: theme.spacing.md },
  ...
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: theme.colors.textMain, marginTop: theme.spacing.md, marginBottom: theme.spacing.sm },
  contactCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  contactInfo: { flex: 1 },
  contactRole: { fontSize: 12, color: theme.colors.textLight, marginBottom: 2, textTransform: 'uppercase' },
  ...
  callIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#E8F5E9', alignItems: 'center', justifyContent: 'center' },
  ...
  version: { textAlign: 'center', fontSize: 12, color: theme.colors.textLight, marginTop: theme.spacing.xl }
});
